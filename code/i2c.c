...
// }
//
// /* Write a single byte to I2C slave */
...
//      * [0]     = 0 (write operation)
//      */
//     ctrl_val = ((unsigned int)data << 24) | ((unsigned int)(slave_addr & 0x7F) << 8) | I2C_WRITE;
//     *I2C_CTRL = ctrl_val;
//
...
//     i2c_wait_done();
//
//     /* Read data from status register [31:24] */
//     status = *I2C_STATUS;
//     return (unsigned char)(status >> 24);
// }
//
...
//     uart_puts("\r\n");
// }
/* I2C Master Controller Implementation - TEST VERSION
 * Modified for testing without slave - no wait on write operations
 */
...
void i2c_print_status(void)
{
    ...
    uart_puts("I2C Status reg:\r\n");

   
    uart_print_hex(status);
    uart_puts("\r\n");
    uart_puts("  ctrl Register: 0x");
